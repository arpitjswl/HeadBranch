...
--Plans Table data
--INSERT INTO Plans (plan_id , plan_name, plan_premium, plan_coverage, co_payment, plan_type,insurance_provider)
--VALUES (101, 'iProtect Smart', 9000, 600000, 10, 'HEALTH', 'ICICI');
--INSERT INTO Plans (plan_id, plan_name, plan_premium, plan_coverage, co_payment, plan_type,insurance_provider)
--VALUES (102, 'Click 2 Protect 3D Plus', 1000, 700000, 12, 'TERM', 'HDFC');
--INSERT INTO Plans (plan_id ,plan_name, plan_premium, plan_coverage, co_payment, plan_type,insurance_provider)
--VALUES (103, 'Bajaj Allianz life Smart Protect Goal', 4000, 800000, 9, 'HEALTH', 'BAJAJ ALLIANZ');
