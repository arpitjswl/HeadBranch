...
public class App {
	public static void main(String[] args) {
		...
		/*
		 * Arpit arpitObj = new Arpit(); arpitObj.setName("Arpit");
		 * 
		 * Car car = new Car(); car.setCarName("BMW");
		 * 
		 * Car car1 = new Car(); car1.setCarName("Ferrari");
		 * System.out.println("GOT!!!!" +arpitObj.getList());
		 * arpitObj.getList().add(car); arpitObj.getList().add(car1);
		 */
        
		/*
		 * ClienData client = new ClienData(); client.setClientName("Arpit");
		 * 
		 * Vehicle veh = new Vehicle(); veh.setName("BMW");
		 * 
		 * client.setVehicle(veh);
		 * 
		 * sess.save(client);
		 */
